...
static const auto initializer_expression_def
	= (
...
static const auto i32_initializer_expression_def
	= (
		  (x3::byte_(relax_enum(wasm::opc::OpCode::I32_CONST))  >> varint32)
		| (x3::byte_(relax_enum(wasm::opc::OpCode::GET_GLOBAL)) >> varuint32)
	);
...
static const auto global_entry_def
