...
#include "wasm_function_storage.h"
...
{
	if(not func_storage)
		throw std::bad_alloc("Failed to allocate memory for function definition");
}
...
void wasm_function::WasmFunctionDeleter::operator()(const void* func_storage) 
{
