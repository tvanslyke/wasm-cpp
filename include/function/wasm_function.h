...
private:
	...
	struct FuncSig{
		...
		std::size_t compute_hash() const
		{
			...
			std::size_t p_hash = std::hash<std::size_t>{}(param_count);
...
struct wasm_function
{
	...
	wasm_function(const code_string_t& code_str, func_sig_id_t sig, std::size_t nparams, std::size_t nlocals, std::size_t nreturns);
